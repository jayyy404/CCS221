...
y = st.slider("Enter for y:", -10, 10, step=1,key='my_slider1')
z = st.slider("Enter for z:", -10, 10, step=1,key='my_slider1')
...
x = st.slider("Enter for x:", -10, 10, step=1,key='my_slider2')
y = st.slider("Enter for y:", -10, 10, step=1,key='my_slider2')
z = st.slider("Enter for z:", -10, 10, step=1,key='my_slider2')
...
x = st.slider("Enter for x:", -10, 10, step=1,key='my_slider3')
y = st.slider("Enter for y:", -10, 10, step=1,key='my_slider3')
